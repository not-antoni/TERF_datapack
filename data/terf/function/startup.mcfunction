...
data modify storage terf:constants materials.terf:multimeter set value {id:carrot_on_a_stick, item_name:"Multimeter", item_model:"terf:tool/multimeter", custom_data:{rechargable:1b,terf:{click:"terf:entity/player/tool/multimeter/activated"}}, lore:[{"text":"Because licking the wire is frowned upon.","italic":false,"color":"gray"}]}

data modify storage terf:constants materials.terf:dosimeter set value {id:carrot_on_a_stick, item_name:"Dosimeter", item_model:"terf:tool/dosimeter", custom_data:{terf:{held:"terf:entity/player/tool/dosimeter/held"}}, lore:[{"text":"3.6 Roentgen. Not great, not terrible.","italic":false,"color":"gray"}]}
...
data modify storage terf:constants materials.terf:fluid_id set value {id:carrot_on_a_stick, item_name:"Fluid ID Tool", item_model:"terf:tool/fluid_id", custom_data:{terf:{click:"terf:entity/player/tool/fluid_id/activated",click_offhand:""}}, lore:[{"text":"Yep, that's liquid.","italic":false,"color":"gray"}]}
...
data modify storage terf:constants materials.terf:syringe set value {id:carrot_on_a_stick, item_name:"Syringe", item_model:"terf:tool/syringe", custom_data:{terf:{click:"terf:entity/player/tool/syringe/activated",click_offhand:""}}, custom_model_data:{colors:[I;0],floats:[0]}, lore:[{"text":"Don't share needles.","italic":false,"color":"gray"}]}
...
data modify storage terf:constants materials.terf:electromagnetic_capsule set value {id:carrot_on_a_stick, item_name:"Electromagnetic Capsule", item_model:"terf:tool/electromagnetic_capsule", custom_data:{terf:{capsule_contents:[{id:"empty",amount:0,max:2000}],click:"terf:entity/player/tool/capsule/activated",click_offhand:""}}, custom_model_data:{colors:[I;6908265],floats:[0]}, max_damage:1000000, lore:[{"text":"Not edible.","italic":false,"color":"red"}]}
data modify storage terf:constants materials.terf:electromagnetic_capsule_full set value {id:carrot_on_a_stick, item_name:"Electromagnetic Capsule", item_model:"terf:tool/electromagnetic_capsule", custom_data:{terf:{capsule_contents:[{id:"terf.antihydrogen",amount:2000,max:2000}],click:"terf:entity/player/tool/capsule/activated",click_offhand:""}}, custom_model_data:{colors:[I;6908265],floats:[0]}, max_damage:1000000, lore:[{"text":"Not edible.","italic":false,"color":"red"}]}
...
data modify storage terf:constants materials.terf:shrink_ray set value {item_name:"Shrink Ray", item_model:"terf:tool/shrink_ray", custom_data:{rechargable:1b,terf:{click:"terf:entity/player/tool/shrink_ray/activated",click_offhand:"terf:entity/player/tool/shrink_ray/activated_offhand"}}, max_stack_size:1, max_damage:100000, damage:0, rarity:epic, consumable:{consume_seconds:1000000}, lore:[{"text":"Right-click to shrink entity","italic":false,"color":"gray"},{"text":"Shift-right-click to grow entity","italic":false,"color":"gray"},{"text":"Look straight down to use on yourself","italic":false,"color":"gray"},{"text":"","italic":false},{"text":"Use this so you can artificially jonabug yourself.","italic":false,"color":"gray"}]}

data modify storage terf:constants materials.terf:maintenance_scanner set value {id:carrot_on_a_stick, item_name:"Maintenance Scanner", item_model:"terf:tool/crane_remote", custom_data:{rechargable:1b,terf:{click:"terf:entity/player/tool/maintenance_scanner/activated"}}, max_damage:100000, damage:0, lore:[{"text":"Did you try turning it off and on again?","italic":false,"color":"gray"}]}
